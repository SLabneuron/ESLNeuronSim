...
class ABECA:
    ...
    def run(self):
        ...
        # variables
        x = np.arange(0, params["N"], 1, dtype=np.int16)                            # 0~64
        y = np.arange(0, params["N"], 1, dtype=np.int16)
        p = np.array([0, 2, 4, 8, 16, 32, 48, 63], dtype=np.int16)         # 0, 2, 4, 8, 16, 32
        q = np.array([0, 2, 4, 8, 16, 32, 48, 63], dtype=np.int16)
        phX = np.arange(0, 1.0, 0.1, dtype=np.float64)             # 0, 0.2, 0.4, 0.6, 0.8
        phY = np.arange(0, 1.0, 0.1, dtype=np.float64)
