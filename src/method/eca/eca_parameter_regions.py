...
class PRECA:
    ...
    def run(self):
        ...
        Q_list, S_list, x_max_list, x_min_list = self.calc_parameter_region(init_x, init_y, init_P, init_Q, init_phX, init_phY,
    ...
    @staticmethod
    @njit(parallel=True)
    def calc_parameter_region(init_x, init_y, init_P, init_Q, init_phX, init_phY,
                              N, M, s1, s2, gamma_X, gamma_Y, Tc, Tx, Ty,
                              sT, eT,
                              tau1, b1, WE11, WE12, WI11, WI12,
                              tau2, b2, WE21, WE22, WI21, WI22,
